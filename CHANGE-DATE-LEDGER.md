...
|---|---|---|
| `packages/connector-*` | Apache 2.0 | does not exist yet |
| `packages/packs-*` | Apache 2.0 | does not exist yet |
| `packages/contracts` | Apache 2.0 | does not exist yet |
| `apps/cli` | Apache 2.0 | does not exist yet |
